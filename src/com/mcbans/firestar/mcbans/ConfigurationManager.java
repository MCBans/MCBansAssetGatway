...
public class ConfigurationManager {
    ...
    /* *** For AssetGateway version */
    public boolean autoBanPerma(){
        return conf.getBoolean("autoBan.permabanned", true);
    }
    public boolean autoBanRep(){
        return conf.getBoolean("autoBan.minRep", false);
    }
